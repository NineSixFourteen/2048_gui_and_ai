...
class application(tk.Frame):
    ...
    def __init__(self):
        ...
        self.board = Board() # make 2048 board
    ...
    def drawRightBottomM(self):
        ...
        self.refreshButton = HoverButton(self.right_panel_bottomM, text ="Refresh", command =  self.updateEverything,image = self.refresh,bg="grey")   
